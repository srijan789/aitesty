...
class TestRun(db.Model):
    ...
    pipeline_run_id = db.Column(db.String(36), db.ForeignKey("pipeline_runs.id", ondelete="CASCADE"), nullable=True)
    run_type = db.Column(db.String(50), default="exploration")  # exploration, generation, test_execution, healing
    attempt_number = db.Column(db.Integer, default=1)
    trigger = db.Column(db.String(50), default="manual")        # manual, scheduled, webhook, pipeline
